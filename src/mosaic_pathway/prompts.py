...
1. Use only the supplied Mosaic context.
2. Do not introduce named resources that are absent from the context.
...
10. Every resource recommendation must reference a supplied source_id.
11. If the context is insufficient, say so rather than inventing information.
""".strip()
